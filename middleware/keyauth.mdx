...
<ParamField path="Extractor" type="extractors.Extractor" default='extractors.FromAuthHeader("Bearer")'>
  Defines how to extract the key from the request. See [Extractors Guide](/guides/extractors).
</ParamField>
...
KeyAuth uses the shared [extractors package](/guides/extractors). Common extractors:
...
See the [Extractors Guide](/guides/extractors) for details.